...
def mine_block():
    ...
    blockchain.add_transactions(sender=node_address,receiver='Bishwo',amount=10)
    #new block is mined
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'The nodes had different chain so the chains was replaced by the leading longest',
                    'new_chain':blockchain.chain}
    else:
        response = {'message': 'ALl good the the chain is the largest one',
